...
import gui.panel.LeaseDashboard;
 ...
 */
public class LeaseManagement extends javax.swing.JFrame implements model.FrameAdditional {
    ...
    public LeaseManagement(String un) {
        initComponents();
        this.un = un;
        setLogo();
        loadHeader();
    ...
    private void viewLease() {
        lease = new LeaseLease(this);
        lease.setSize(jLayeredPane1.getSize());

        jLayeredPane1.removeAll();

        jLayeredPane1.add(lease);
        jLayeredPane1.revalidate();
        jLayeredPane1.repaint();
    ...
    private void viewDashboard() {
        LeaseDashboard dashbaord = new LeaseDashboard();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        viewLease();        // TODO add your handling code here:
...
//        //</editor-fold>
//        //</editor-fold>
        InputStream is = LeaseManagement.class.getResourceAsStream("/theam/arc-theme-orange.theme.json");
