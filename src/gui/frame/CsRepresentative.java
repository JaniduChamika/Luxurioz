...
import gui.panel.CSCust;
import gui.panel.CSRepairReq;
 ...
 */
public class CsRepresentative extends javax.swing.JFrame implements model.FrameAdditional {

    /**
     * Creates new form Admin
     */
    CSRepairReq repariReq;
    CSComplaint complaint;
    CSCust customer;
    String un = "Username";
    String role = "CS Representative";
    ...
    public CsRepresentative(String un) {
        initComponents();
        this.un = un;
        setLogo();
        loadHeader();
    ...
    private void ViewRepairReq() {
        repariReq = new CSRepairReq();
        repariReq.setSize(jLayeredPane1.getSize());

        jLayeredPane1.removeAll();

        jLayeredPane1.add(repariReq);
    ...
    private void ViewComplaint() {
        complaint = new CSComplaint(this);
    ...
    private void initComponents() {
        ...
        setTitle("Customer Service Representative");
        setResizable(false);
...
//        //</editor-fold>
        ...
        InputStream is = CsRepresentative.class.getResourceAsStream("/theam/arc-theme-orange.theme.json");
