...
public class Role extends javax.swing.JDialog {
    ...
    public Role(java.awt.Frame parent, AdminUsers panel, boolean modal) {
        super(parent, modal);
        this.panel = panel;
        initComponents();
        setNewButtonUI();
    ...
    public void loadRole() {
        ...
        try {
            ...
            rs = MySQL.search("SELECT * FROM user_role ");
    ...
    private void addRole() {
        ...
        if (text.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter role", "Warning", JOptionPane.WARNING_MESSAGE);

        } else {
            try {

                ResultSet rs2 = MySQL.search("SELECT * FROM `user_role` WHERE `name`='" + text + "'");
                if (rs2.next()) {
                    JOptionPane.showMessageDialog(this, "Already exist role", "Warning", JOptionPane.WARNING_MESSAGE);

                } else {
                    MySQL.iud("INSERT INTO `user_role` (`name`) "
                            + "VALUES ('" + text + "')");
