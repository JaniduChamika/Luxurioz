 ...
 * @author Janidu
 */
public class ItemCategory extends javax.swing.JDialog {
    ...
    private PropItem panel;

    public ItemCategory(java.awt.Frame parent, boolean modal) {
    ...
    public ItemCategory(java.awt.Frame parent, boolean modal, PropItem panel) {
        super(parent, modal);
    ...
    private void addCategory() {
        ...
        if (text.isEmpty()) {
            ...
            try {
                ...
                ResultSet rs2 = MySQL.search("SELECT * FROM `item_category` WHERE `name`='" + text + "'");
                if (rs2.next()) {
                    JOptionPane.showMessageDialog(this, "Already exist type", "Warning", JOptionPane.WARNING_MESSAGE);

                } else {
                    MySQL.iud("INSERT INTO `item_category` (`name`) "
                            + "VALUES ('" + text + "')");

                    loadCategory();
                    jTextField1.setText("");
                 
                    this.panel.loadCategory();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ItemCategory dialog = new ItemCategory(new javax.swing.JFrame(), true);
