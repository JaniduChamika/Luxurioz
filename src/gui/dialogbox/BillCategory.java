 ...
 * @author Janidu
 */
public class BillCategory extends javax.swing.JDialog {

    /**
     * Creates new form BillCategory
     */
    public BillCategory(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public BillCategory(java.awt.Frame parent, boolean modal, PropBillIssue panel) {
        super(parent, modal);
    ...
    public void loadCategory() {
        ...
        try {
            ...
            rs = MySQL.search("SELECT * FROM `category` WHERE `id` NOT IN (1,2,3,5)");
    ...
    private void addCategory() {
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                ResultSet rs2 = MySQL.search("SELECT * FROM `category` WHERE `name`='" + name + "' AND `id` NOT IN (1,2,3,5)");
                if (rs2.next()) {
                    JOptionPane.showMessageDialog(this, "Already exist category", "Warning", JOptionPane.WARNING_MESSAGE);

                } else {
                    MySQL.iud("INSERT INTO `category` (`name`) "
                            + "VALUES ('" + name + "')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillCategory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BillCategory dialog = new BillCategory(new javax.swing.JFrame(), true);
