...
public class Condition extends javax.swing.JDialog {
    ...
    public Condition(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public Condition(java.awt.Frame parent, boolean modal, PropApartment panel) {
        super(parent, modal);
        initComponents();
        CustomTable custable = new CustomTable();
...
loadCondition();
    ...
    private void addCondition() {
        ...
        if (text.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter condition", "Warning", JOptionPane.WARNING_MESSAGE);
            ...
            try {
                ...
                ResultSet rs2 = MySQL.search("SELECT * FROM `condition` WHERE `name`='" + text + "'");
                if (rs2.next()) {
                    JOptionPane.showMessageDialog(this, "Already exist condition", "Warning", JOptionPane.WARNING_MESSAGE);

                } else {
                    MySQL.iud("INSERT INTO `condition` (`name`,`addion_rate`) "
                            + "VALUES ('" + text + "','" + rate + "')");

                    loadCondition();
                    jTextField1.setText("");
                    jTextField2.setText("");
                    this.panel.loadCondition();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Category", "Additional Charge Rate"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Condition dialog = new Condition(new javax.swing.JFrame(), true);
