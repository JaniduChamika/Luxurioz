...
import gui.panel.PropBillIssue;
import gui.panel.PropDashboard;
 ...
 *
 */
public class PropertyManager extends javax.swing.JFrame implements model.FrameAdditional {

    /**
     * Creates new form Admin
     */
    PropApartment aprtment;
    PropBillIssue billIsse;
    PropItem item;
    PropRepairReq repairReq;
    String un = "Username";
    ...
    public PropertyManager(String un) {
        initComponents();
        this.un = un;
        setLogo();
        loadHeader();
    ...
    private void viewDashboard() {
        PropDashboard dashbaord = new PropDashboard();
    ...
    private void viewApartment() {
        aprtment = new PropApartment(this);
    ...
    private void viewBillIssue() {
        billIsse = new PropBillIssue(this);
        billIsse.setSize(jLayeredPane1.getSize());

        jLayeredPane1.removeAll();

        jLayeredPane1.add(billIsse);
        jLayeredPane1.revalidate();
        jLayeredPane1.repaint();
    ...
    private void viewItem() {
        item = new PropItem(this);
        item.setSize(jLayeredPane1.getSize());
    ...
    private void viewRepairReq() {
        repairReq = new PropRepairReq(this);
    ...
    private void initComponents() {
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-item-48.png"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        viewItem();        // TODO add your handling code here:
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        viewBillIssue();        // TODO add your handling code here:
...
//        //</editor-fold>
        ...
        InputStream is = PropertyManager.class.getResourceAsStream("/theam/arc-theme-orange.theme.json");
