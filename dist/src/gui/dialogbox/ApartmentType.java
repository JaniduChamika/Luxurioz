 ...
 * @author Janidu
 */
public class ApartmentType extends javax.swing.JDialog {

    /**
     * Creates new form ApartmentType
     */
    DecimalFormat df = new DecimalFormat("#0.00");

    private PropApartment panel;

    public ApartmentType(java.awt.Frame parent, boolean modal) {
    ...
    public ApartmentType(java.awt.Frame parent, boolean modal, PropApartment panel) {
        super(parent, modal);
    ...
    private void loadType() {
        try {
            ...
            while (rs.next()) {
                ...
                v.add(df.format(Double.parseDouble(rs.getString("addition_rate"))));
                dtm.addRow(v);
    ...
    private void addApartmentType() {
        ...
        if (text.isEmpty()) {
            ...
            try {
                ...
                ResultSet rs2 = MySQL.search("SELECT * FROM `apartment_type` WHERE `name`='" + text + "'");
                if (rs2.next()) {
                    JOptionPane.showMessageDialog(this, "Already exist type", "Warning", JOptionPane.WARNING_MESSAGE);

                } else {
                    MySQL.iud("INSERT INTO `apartment_type` (`name`,`addition_rate`) "
                            + "VALUES ('" + text + "','" + rate + "')");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Apartment Facilities", "Additional Charge Rate"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApartmentType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ApartmentType dialog = new ApartmentType(new javax.swing.JFrame(), true);
