 ...
 * @author Janidu
 */
public class CompliantCategory extends javax.swing.JDialog {
    ...
    public CompliantCategory(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setNewButtonUI();
        startLisners();
    ...
    public CompliantCategory(java.awt.Frame parent, CSComplaint panel, boolean modal) {
        super(parent, modal);
        initComponents();
        this.panel = panel;
        setNewButtonUI();
    ...
    public void loadCategory() {
        ...
        try {
            ...
            rs = MySQL.search("SELECT * FROM com_category ");
    ...
    private void addCategory() {
        ...
        if (text.isEmpty()) {
            ...
            try {
                ...
                ResultSet rs2 = MySQL.search("SELECT * FROM `com_category` WHERE `name`='" + text + "'");
                if (rs2.next()) {
                    JOptionPane.showMessageDialog(this, "Already exist category", "Warning", JOptionPane.WARNING_MESSAGE);

                } else {
                    MySQL.iud("INSERT INTO `com_category` (`name`) "
                            + "VALUES ('" + text + "')");

                    loadCategory();
                    jTextField1.setText("");
                    panel.loadComplaintCategpry();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompliantCategory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CompliantCategory dialog = new CompliantCategory(new javax.swing.JFrame(), true);
