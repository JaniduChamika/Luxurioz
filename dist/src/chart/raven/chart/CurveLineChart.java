...
import chart.raven.chart.blankchart.BlankPlotChart;
import chart.raven.chart.blankchart.BlankPlotChatRender;
import chart.raven.spline.Spline;
import chart.raven.spline.SplinePoint;
...
public class CurveLineChart extends JComponent {
    ...
    private void createPanelLegend() {
        ...
        labelTitle.setFont(labelTitle.getFont().deriveFont(Font.BOLD, 18));
...
//        labelTitle.setFont(font);
        labelTitle.setFont(new java.awt.Font("Roboto", 1, 18));
